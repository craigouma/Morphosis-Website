...
(function ($) {
    ...
    window.VcAccordionTabView = window.VcColumnView.extend({
        events:{
            'click > .vc_controls .column_delete,.vc_control-btn-delete':'deleteShortcode',
            'click > .vc_controls .column_add,.vc_control-btn-prepend':'addElement',
            'click > .vc_controls .column_edit,.vc_control-btn-edit':'editElement',
            'click > .vc_controls .column_clone,.vc_control-btn-clone':'clone',
