...
foreach($graph_lines_data as $line) {
	...
	//<div class="progress-bar"><span class="bar-label">Web Design</span><span class="bar-meter solid-red" data-meter="60"></span></div>
	...
	$output .= '<span class="bar-meter ' . $bgcolor . ' " ' . $custombgcolor . ' data-meter="' . $percentage_value . '"></span>';
    $output .= '</div>'; // END: class="progress-bar"
