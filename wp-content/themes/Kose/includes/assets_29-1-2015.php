...
if ( ! function_exists( 'uxbarn_load_js' ) ) {
	...
	function uxbarn_load_js() {
		...
		//wp_register_script( 'uxbarn-modernizr-custom', get_template_directory_uri() . '/js/modernizr.custom.js', array( 'jquery' ), null, false );
		...
		//wp_enqueue_script( 'uxbarn-modernizr-custom' );
