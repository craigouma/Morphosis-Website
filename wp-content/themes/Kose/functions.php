...
require_once( get_template_directory() . '/widgets/Related-posts.php' );
...
function recent_posts_function($atts){
   ...
   if (have_posts()) :
      while (have_posts()) : the_post(); 
	   ...
	   $post_excerpt = uxbarn_get_array_value( get_post_meta( get_the_ID(), 'uxbarn_post_excerpt' ), 0 );
	   $post_video = uxbarn_get_array_value( get_post_meta( get_the_ID(), 'uxbarn_portfolio_meta_video' ), 0 );
      ...
      ';
       ...
       $return_string.= '<img src="'.get_template_directory_uri().'/images/camera.png" />';
                    } else if(in_category( 'video', $post->ID )){
       $return_string.= '<img src="'. get_template_directory_uri().'/images/video.png" />';
                     } else{
       $return_string.= '<img src="'.get_template_directory_uri().'/images/quote.png" />';
       } 
	 ...
	 $image_src = wp_get_attachment_image_src( get_post_thumbnail_id(), 'large', true );
	 $return_string.= '<div class="blog-thumbnail '.$blog_thumbnail_class.'"><a href="'.get_permalink().'" class="image-link"><img src="'.$image_src[0].'" style="width:100%; height:auto;" /></a></div>';
            endif; }
